...
namespace TestyJezyka
{
    ...
    public partial class Odbiorca
    {
        ...
        public Nullable<int> idObiekt { get; set; }
        public Nullable<int> idZaklad { get; set; }
        public string KodPocztowy { get; set; }
        public Nullable<int> idMiasto { get; set; }
        public Nullable<int> idUlica { get; set; }
        public string NrBudynku { get; set; }
        public Nullable<int> idTypOdbiorcy { get; set; }
